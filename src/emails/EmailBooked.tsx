...
export const EmailRdvBooked = ({
  ...
  const optionsForDate: Intl.DateTimeFormatOptions = { day: 'numeric', month: 'long', year: 'numeric' };
  const optionsForTime: Intl.DateTimeFormatOptions = { hour: '2-digit', minute: '2-digit' };

  const dateString = bookingStartTimeFormatted.toLocaleDateString('fr-FR', optionsForDate);
  const heureString = bookingStartTimeFormatted.toLocaleTimeString('fr-FR', optionsForTime);
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Heading style={heading}>
            🪄 Bonjour {customerName} et merci pour votre réservation au sein du FinestLash Studio le {bookingStartTime && dateString} à {bookingStartTime && heureString} !
          </Heading>
          <Section style={body}>
